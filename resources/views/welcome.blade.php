        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100  selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        <a href="{{ url('/services') }}" class="font-semibold text-gray-100  py-3 px-6 bg-gray-800 hover:bg-gray-900 shadow-md rounded-full focus:outline focus:outline-2 focus:rounded-full focus:outline-gray-400">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="font-semibold text-gray-100  py-3 px-6 bg-emerald-400 hover:bg-emerald-500 shadow-md rounded-full  focus:outline focus:outline-2 focus:rounded-full focus:outline-gray-400">Log in</a>
                ...
                @auth
                  <div class="text-center">
                    <h1 class="text-5xl font-semibold text-gray-900 leading-relaxed">Welcome to your dashboard</h1>
                    <p class="text-xl text-gray-500 mt-4">You are logged in!</p>
                  @else
                  <div class="loader">
                    <div class="wrapper">
