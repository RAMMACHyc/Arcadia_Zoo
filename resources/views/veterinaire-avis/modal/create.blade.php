<button data-modal-target="createAvisModal" data-modal-toggle="createAvisModal"
...
<div id="createAvisModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="createAvisModal">
            ...
            <div class="p-4 md:p-5">
                <form action="{{ route('veterinaire-avis.store') }}" method="POST">
                    @csrf
                    <div>
                        <label for="animal_id"
                    ...
                    <div>
                        <label for="date_passage"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date</label>
                        <input type="date" name="date_passage" id="date_passage"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            required>
                        @error('date_passage')
                            <div class="text-danger">{{ $message }}</div>
                    ...
                    <div>
                        <label for="etat_animal"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">État de
                            l'animal</label>
                        <input type="text" name="etat_animal" id="etat_animal"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            required>
                        @error('etat_animal')
                            <div class="text-danger">{{ $message }}</div>
                    ...
                    <div>
                        <label for="nourriture"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nourriture</label>
                    ...
                    <div>
                        <label for="grammage_nourriture"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Grammage</label>
                        <input type="number" name="grammage_nourriture" id="grammage_nourriture"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            required>
